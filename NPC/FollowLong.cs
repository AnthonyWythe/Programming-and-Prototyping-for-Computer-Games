...
public class FollowLong : MonoBehaviour {
    ...
    public Transform point3;            //The fourth waypoint
    public Transform point4;            //The fifth waypoint
    public Transform point5;            //The sixth waypoint
    public Transform point6;            //The seventh waypoint
    public Transform point7;            //The eigth waypoint
    public Transform point8;            //The ninth waypoint
    public Transform point9;            //The tenth waypoint
    ...
    bool updated = false;               //Bool for updating waypoints
    ...
    public void UpdatePoint()
    {
        ...
        else if (currentPoint == point2 && newPoint == point3)
        {
            currentPoint = point3;
            newPoint = point4;
        }
        else if (currentPoint == point3 && newPoint == point4)
        {
            currentPoint = point4;
            newPoint = point5;
        }
        else if (currentPoint == point4 && newPoint == point5)
        {
            currentPoint = point5;
            newPoint = point6;
        }
        else if (currentPoint == point5 && newPoint == point6)
        {
            currentPoint = point6;
            newPoint = point7;
        }
        else if (currentPoint == point6 && newPoint == point7)
        {
            currentPoint = point7;
            newPoint = point8;
        }
        else if (currentPoint == point7 && newPoint == point8)
        {
            currentPoint = point8;
            newPoint = point9;
        }
        else if (currentPoint == point8 && newPoint == point9)
        {
            currentPoint = point9;
            newPoint = point5;
        }
        
        //After 0 - 9 are complete, rejoin at 5 and follow back to 0
        else if (currentPoint == point9 && newPoint == point5)
        {
            currentPoint = point5;
            newPoint = point4;
        }
        else if (currentPoint == point5 && newPoint == point4)
        {
            currentPoint = point4;
            newPoint = point3;
        }
        else if (currentPoint == point4 && newPoint == point3)
        {
            currentPoint = point3;
            newPoint = point2;
        }
        else if (currentPoint == point3 && newPoint == point2)
        {
            currentPoint = point2;
            newPoint = point1;
        }
